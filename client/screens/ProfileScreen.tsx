      ...
      {isLoading ? (
        ...
        <View style={styles.bookingsList}>
          {bookings.map((booking: any) => (
            <View key={booking.id} style={[styles.bookingCard, { backgroundColor: theme.cardBackground }]}>
              <View style={[styles.bookingIcon, { backgroundColor: theme.primary + "20" }]}>
                <Feather name={typeIcon(booking.type)} size={18} color={theme.primary} />
              </View>
              <View style={styles.bookingInfo}>
                <Text style={[styles.bookingName, { color: theme.text }]}>{booking.item_name}</Text>
                ...
                <Text style={[styles.bookingAmount, { color: theme.textSecondary }]}>${booking.amount}</Text>
              </View>
        ...
        <View style={[styles.emptyBookings, { backgroundColor: theme.cardBackground }]}>
          <Feather name="calendar" size={40} color={theme.textSecondary} />
          <Text style={[styles.emptyText, { color: theme.textSecondary }]}>No bookings yet</Text>
